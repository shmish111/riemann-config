...
job "riemann" {
  ...
  group "riemann" {
    ...
    task "riemann" {
      ...
      config {
        command = "riemann-0.2.11/bin/riemann"
        args    = ["local/riemann.config"]
        #port_map {
        #  tcp = 5555
        #}
      }
      ...
      #
      artifact {
         source = "http://localhost:8000/riemann-0.2.11.zip"
         #source = "https://aphyr.com/riemann/riemann-0.2.11.tar.bz2"
         #destination = "/home/vagrant/riemann"
      #   options {
      #     checksum = "md5:c4aa853ad2215426eb7d70a21922e794"
      #   }
      }
      artifact {
        source = "http://localhost:8000/riemann.config"
      }
